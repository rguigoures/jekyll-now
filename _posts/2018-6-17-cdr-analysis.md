...
{% include image.html url="https://rguigoures.github.io/images/itcc_map.png" width=500 description="Fig.3 - Map of Milan. One square represent one antenna. There is one color per cluster. Detailed Map on [OpenStreet map]("https://rguigoures.github.io/images/map_itcc.geojson")." %}
